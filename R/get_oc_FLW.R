#'
#' Generate operating characteristics of Curve-Free Design for Maximum Tolerated Dose in One-Agent Trials
#'
...
#' @param n.min.mtd the minimal sample size for MTD identification
#' @param n.max.mtd the maximal sample size for MTD identification
...
#'
#' @details The operating characteristics of the Curve-Free design are generated by simulating trials under the prespecified true toxicity probabilities.
#'          In this design, a Bayesian model on the toxicity rates is used to locate the maximum tolerated doese.
#'
#' @return \code{get_oc_FLW()} returns the operating characteristics of the CFBD design as a list,
#'         including:
